...
interface Props {
  ...
  onZoomChange: (percent: number) => void; validation?: TranslationKey; onValidation: (key?: "road.invalid.water" | "road.invalid.short" | "zone.noRoadArea" | "building.invalid") => void; t: (key: TranslationKey) => string;
}
