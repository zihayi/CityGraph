...
export function OSMDownloadPanel({ locale, layers, onLayers, onReady, onBusy, t }: Props) {
  ...
  return <section className="osm-download-panel" aria-label={t("osm.online")}>
    <div className="osm-download-main">
    ...
    <div className="osm-download-options">
    ...
    {(size.width > 2000 || size.height > 2000) && <p className="osm-import-help">{t("osm.largeAreaHint")}</p>}
