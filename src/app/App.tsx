...
export function App() {
  ...
  const [validation, setValidation] = useState<"road.invalid.water" | "road.invalid.short" | "zone.noRoadArea" | undefined>(); const mapRef = useRef<MapCanvasHandle>(null); const t = useTranslation();
  ...
  return <div className="app-shell" data-revision={revision} data-toolbar-collapsed={store.toolbarCollapsed}>
