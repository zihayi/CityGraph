...
export function App() {
  ...
  const [validation, setValidation] = useState<"road.invalid.water" | "road.invalid.short" | "zone.noRoadArea" | "building.invalid" | undefined>(); const mapRef = useRef<MapCanvasHandle>(null); const t = useTranslation();
