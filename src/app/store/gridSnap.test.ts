...
const layers = { baseMap: true, roads: true, buildings: true, facilities: true, poi: true, transit: true, parks: true, districts: true, water: true, labels: true, zoning: false, grid: false } as const;
