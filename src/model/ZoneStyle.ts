...
export const editableZoneTypes = ["residential", "commercial", "education", "medical", "government", "industrial", "office", "green", "tourism", "zoo", "amusement-park", "golf-course", "resort", "high-speed-rail-station", "train-station", "airport", "custom"] as const satisfies readonly ZoneType[];
